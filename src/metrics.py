...
# Seqeval directly supports IOB, IOB2,
# see https://github.com/chakki-works/seqeval
metric = load_metric("seqeval")


class MetricCalculator:
    def __init__(self, get_name_from_class: Callable[[int], str]) -> None:
        self.get_name_from_class = get_name_from_class
    ...
    def compute_metrics(self, p: EvalPrediction):
        ...
        labels_true = self._convert_classes_to_labels(y_true, y_true)
        labels_pred = self._convert_classes_to_labels(y_pred, y_true)
    ...
    def _convert_classes_to_labels(self, classes, classes_true) -> List[List[str]]:
